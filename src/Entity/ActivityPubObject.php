...
class ActivityPubObject implements ArrayAccess
{
     ...
     * @ORM\OneToMany(targetEntity="Field", mappedBy="object", cascade={"persist", "remove"})
     ...
     * @ORM\OneToMany(targetEntity="Field", mappedBy="targetObject")
     * @var Field[] An ArrayCollection of Fields
     */
     ...
     * @ORM\OneToOne(targetEntity="PrivateKey", mappedBy="object", cascade={"all"})
     * @var PrivateKey
     */
