...
final class Version20190519152722 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE base_object (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, base_type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE actor (id INT NOT NULL, username VARCHAR(255) NOT NULL, summary LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_447556F9F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE organization (id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE object (id INT NOT NULL, content LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE device ADD CONSTRAINT FK_92FB68EA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE actor ADD CONSTRAINT FK_447556F9BF396750 FOREIGN KEY (id) REFERENCES base_object (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE application ADD CONSTRAINT FK_A45BDDC1BF396750 FOREIGN KEY (id) REFERENCES base_object (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE organization ADD CONSTRAINT FK_C1EE637CBF396750 FOREIGN KEY (id) REFERENCES base_object (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE authorization ADD CONSTRAINT FK_7A6D8BEFD6EEC6FE FOREIGN KEY (controlled_actor_id) REFERENCES organization (id)');
        ...
        $this->addSql('ALTER TABLE activity ADD CONSTRAINT FK_AC74095A232D562B FOREIGN KEY (object_id) REFERENCES base_object (id)');
        $this->addSql('ALTER TABLE activity ADD CONSTRAINT FK_AC74095ABF396750 FOREIGN KEY (id) REFERENCES base_object (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE object ADD CONSTRAINT FK_A8ADABECBF396750 FOREIGN KEY (id) REFERENCES base_object (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE object DROP FOREIGN KEY FK_A8ADABECBF396750');
