 ...
 */
final class Version20190610093815 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE incoming_webhook (api_key VARCHAR(16) NOT NULL, actor_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', UNIQUE INDEX UNIQ_8FA504B410DAF24A (actor_id), PRIMARY KEY(api_key)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT NOT NULL, actor_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', uuid VARCHAR(36) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(64) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', UNIQUE INDEX UNIQ_8D93D649D17F50A6 (uuid), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D64910DAF24A (actor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE object (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', location_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', attachment_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', type VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, summary LONGTEXT DEFAULT NULL, content LONGTEXT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, published DATETIME DEFAULT NULL, updated DATETIME DEFAULT NULL, class_name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_A8ADABEC64D218E (location_id), UNIQUE INDEX UNIQ_A8ADABEC464E68B (attachment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tag (tagged_object_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', tag_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_389B7835B7EB2CD (tagged_object_id), INDEX IDX_389B783BAD26311 (tag_id), PRIMARY KEY(tagged_object_id, tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE activity (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', actor_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', object_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', is_public TINYINT(1) NOT NULL, INDEX IDX_AC74095A10DAF24A (actor_id), INDEX IDX_AC74095A232D562B (object_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE activity_receiving_actor (activity_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', actor_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_EB60FC2381C06096 (activity_id), INDEX IDX_EB60FC2310DAF24A (actor_id), PRIMARY KEY(activity_id, actor_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE place (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE actor (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', username VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_447556F9F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE following (follower CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', following CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_71BF8DE3B9D60946 (follower), INDEX IDX_71BF8DE371BF8DE3 (following), PRIMARY KEY(follower, following)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE authorization (controlled_actor_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', controlling_actor_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_7A6D8BEFD6EEC6FE (controlled_actor_id), INDEX IDX_7A6D8BEF6E512342 (controlling_actor_id), PRIMARY KEY(controlled_actor_id, controlling_actor_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
